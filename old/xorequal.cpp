...
// damn this is a nice function, very cute. credits:- https://math.stackexchange.com/questions/195634/how-do-you-calculate-the-modulo-of-a-high-raised-number/453108#453108
// i realized I already had a similar function in my template lol, what a dumdum I am
int main() {
	FAST();
	CASE(t) {
		ll n; cin>>n;
		ll res = powM(2, n-1, M1);
		cout<<res<<"\n";
	}
	return 0;
}